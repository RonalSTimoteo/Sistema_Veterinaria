...
function fntEditInfo(idCita){  // si obtiene lo datos
...
//aca se pega el id q viene del modelo 
                    document.querySelector("#txtlistMascota").value = objData.data.id_mas;
                    ...
                    console.log('El valor seleccionado de txtlistMascota es:', document.querySelector("#txtlistMascota").value);
                    console.log('El valor seleccionado de txtnombre es:', document.querySelector("#txtnombre").value);
                    console.log('El valor seleccionado de txtfecha es:', document.querySelector("#txtfecha").value);
                    console.log('El valor seleccionado de txthora es:', document.querySelector("#txthora").value);
                    //  $('#txtlistMascota').selectpicker('val', objData.data.id_mas);
    ...
    if(document.querySelector('#txtlistMascota')){
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
                ...
                $('#txtlistMascota').selectpicker('render');
               console.log('La respuesta de la solicitud es:', request.responseText);
            }
        }
    }
}
